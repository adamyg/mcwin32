...
__CIDENT_RCSID(kbconsole_h,"$Id: kbconsole.h,v 1.2 2024/02/17 08:23:13 cvsuser Exp $")
__CPRAGMA_ONCE
...
void ConsoleClearEOS(HANDLE console);
void ConsoleClearEOL(HANDLE console);

void ConsoleHome(HANDLE console);
int  ConsoleSizeSet(HANDLE console, int width, int height);

void ConsoleHome(HANDLE console);
void ConsolePrintA(HANDLE console, const char *fmt, ...);
void ConsolePrintW(HANDLE console, const wchar_t *fmt, ...);
