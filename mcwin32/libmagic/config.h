...
#define PACKAGE_VERSION     "545"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING      "file 545"
...
#endif
#ifndef pipe
int file_pipe(int fildes[2]);
#define pipe(__a) file_pipe(__a)
...
#define ioctl(__a,__b,__c) file_ioctl(__a,__b,__c)

size_t file_strlcpy(char *dst, const char *src, size_t siz);
size_t file_strlcat(char *dst, const char *src, size_t siz);
#define strlcpy file_strlcpy
#define strlcat file_strlcat
