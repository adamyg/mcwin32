...
#ifdef HAVE_CHARSET
        quick_widget_t quick_widgets[16] = {0},
#else
        quick_widget_t quick_widgets[15] = {0},
#endif
            *qc = quick_widgets;
#else
...
#if defined(WIN32)  //WIN32, quick
#ifdef HAVE_CHARSET
        quick_widget_t quick_widgets[14+2] = {0},
#else
        quick_widget_t quick_widgets[13+2] = {0},
#endif
            *qc = quick_widgets;
#else
        quick_widget_t quick_widgets[] = {
...
edit_dialog_replace_prompt_show (WEdit * edit, char *from_text, char *to_text, int xpos, int ypos)
{
    ...
    {
#if defined(WIN32)  //WIN32, quick
        quick_widget_t quick_widgets[9] = {0},
            *qc = quick_widgets;
#else
        quick_widget_t quick_widgets[] = {
            /* *INDENT-OFF* */
