...
edit_options_dialog (WDialog * h)
{
...

    {
        ...
        quick_widget_t quick_widgets[29+2] = {0},
            *qc = quick_widgets;
#else
        ...
        qc =         XQUICK_CHECKBOX (qc, N_("&Fake half tabs"), &edit_options.fake_half_tabs, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("&Backspace through tabs"), &edit_options.backspace_through_tabs, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("Fill tabs with &spaces"), &edit_options.fill_tabs_with_spaces, NULL),
        ...
        qc =         XQUICK_CHECKBOX (qc, N_("&Return does autoindent"), &edit_options.return_does_auto_indent, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("Confir&m before saving"), &edit_options.confirm_save, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("Save file &position"), &edit_options.save_position, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("&Visible trailing spaces"), &edit_options.visible_tws, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("Visible &tabs"), &edit_options.visible_tabs, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("Synta&x highlighting"), &edit_options.syntax_highlighting, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("C&ursor after inserted block"), &edit_options.cursor_after_inserted_block, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("Pers&istent selection"), &edit_options.persistent_selections, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("Cursor be&yond end of line"), &edit_options.cursor_beyond_eol, NULL),
        qc =         XQUICK_CHECKBOX (qc, N_("&Group undo"), &edit_options.group_undo, NULL),
